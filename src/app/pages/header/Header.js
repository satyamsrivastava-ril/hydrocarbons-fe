          ...
          <div className='row'>
            <div className='col-sm-4 col-6'>
              <div className='header-box'>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="50.874" height="51.064" viewBox="0 0 50.874 51.064">
  <path id="Path_1" data-name="Path 1" d="M279.927,231.125l-12.13,7v14.007l12.13,7,12.13-7V238.128Zm-7.874,18.264a1.064,1.064,0,0,1-2.127,0v-8.512a1.064,1.064,0,0,1,2.127,0Z" transform="translate(-241.183 -208.074)" fill="#4d4d4d"/>
  <path id="Path_2" data-name="Path 2" d="M158.636,7l-12.13-7-12.13,7V21.01l12.13,7,12.13-7ZM146.253,5.062l-7.37,4.254a1.064,1.064,0,1,1-1.064-1.842l7.371-4.257a1.065,1.065,0,0,1,1.063,1.845Z" transform="translate(-121.068)" fill="#acacac"/>
  <path id="Path_3" data-name="Path 3" d="M.953,238.128v14.007l12.13,7,12.13-7V238.128l-12.13-7ZM14.4,234.341,21.77,238.6a1.064,1.064,0,1,1-1.064,1.842l-7.37-4.254a1.065,1.065,0,0,1,1.063-1.845Z" transform="translate(-0.953 -208.074)" fill="#807f7f"/>
</svg>
{' '}
                  <span className='d-inline-block'>HYDROCARBON</span>
                </a>
              </div>
            </div>
            <div className='col-sm-8 col-6 justify-content-end d-flex'>
              <ul className='list-unstyled d-flex mb-0'>
                <li className='pl-3 d-flex align-items-center position-relative'>
                  <a href='#'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      width='32.039'
                      height='34'
                      viewBox='0 0 32.039 34'
                    >
                      <path
                        id='Shape'
                        d='M11.363,30.491a5,5,0,0,1-1.4-2.609H.944a.935.935,0,0,1-.923-.713.893.893,0,0,1,.534-1.013c3.558-1.535,3.693-8.127,3.7-8.293V13.441a10.3,10.3,0,0,1,6.586-9.474A4.08,4.08,0,0,1,15,0a4.081,4.081,0,0,1,4.163,3.966,10.3,10.3,0,0,1,6.586,9.474v4.423c0,.167.138,6.758,3.694,8.294a.891.891,0,0,1,.535,1.012.936.936,0,0,1-.923.713H20.038a5,5,0,0,1-1.4,2.609,5.138,5.138,0,0,1-7.275,0Z'
                    ...
                    <span className='notification d-block position-absolute'></span>
                  </a>
                </li>
                <li className='pl-3  d-flex align-items-center position-relative'>
                  <a href='#'>
                    <svg
                      id='Element_Icon_Mail'
                      data-name='Element/Icon/Mail'
                      xmlns='http://www.w3.org/2000/svg'
                      xlink='http://www.w3.org/1999/xlink'
                      width='26.666'
                      height='21.334'
                      viewBox='0 0 26.666 21.334'
                    >
                      <defs>
                        <clippath id='clip-path'>
                          <path
                            id='Mail'
                            d='M24.242,21.334H2.424A2.4,2.4,0,0,1,0,18.962V2.37A2.4,2.4,0,0,1,2.424,0H24.242a2.4,2.4,0,0,1,2.424,2.37V18.962A2.4,2.4,0,0,1,24.242,21.334ZM2.032,2.843V19.369h22.6V2.843l-11.3,9.126ZM3.81,1.987,13.4,9.437l9.461-7.45Z'
                ...
                <li className='pl-3  d-flex align-items-center  position-relative'>
                  <a href='#'>
                    <span className='profile d-block'>
                      <svg
                        id='Capa_1'
